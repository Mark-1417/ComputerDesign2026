# ============================================================
# ModelSim DO script: 流水线CPU + 学号排序 (rv32_sid_sort_sim.dat)
# 工作目录: d:/COP/newsc
# Usage: do sim_pl_sid.do
# ============================================================
...
# 启动仿真
vsim -voptargs=+acc work.pl_final_tb +IMEM=$TEST_DATA/rv32_sid_sort_sim.dat +CYCLES=800
